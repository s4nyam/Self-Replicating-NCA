INIT_PROBABILITY = 0.50
INHERTIANCE_PROBABILITY  = 0.100 # probability that neighboring cells will inherit by perturbation.
NUM_LAYERS = 2 # rest hidden and one alpha
parameter_perturbation_probability = 0.80
budget_per_cell = 7
