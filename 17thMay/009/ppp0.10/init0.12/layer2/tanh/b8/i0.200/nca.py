INIT_PROBABILITY = 0.12
INHERTIANCE_PROBABILITY  = 0.200 # probability that neighboring cells will inherit by perturbation.
NUM_LAYERS = 2 # rest hidden and one alpha
parameter_perturbation_probability = 0.10
budget_per_cell = 7
