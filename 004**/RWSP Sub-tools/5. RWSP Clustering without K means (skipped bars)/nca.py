...
def save_frame(frame, fig, normalized_data):
    ...
    # Filter out bars with count == 1
    filtered_unique_colors = unique_colors[counts != 1]
    ...
    ax_freq.set_xticklabels([str(color) for color in filtered_unique_colors], rotation=90, fontsize=6)
...
for frame in range(length):
    ...
    save_frame(frame, fig, normalized_data)
