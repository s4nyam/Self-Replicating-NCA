...
INHERTIANCE_PROBABILITY  = 0.8 # probability that neighboring cells will inherit by perturbation.
parameter_perturbation_probability = 0.8
...
activation = 'leakyrelu' # ['relu','sigmoid','tanh','leakyrelu']
frequency_dicts = []
